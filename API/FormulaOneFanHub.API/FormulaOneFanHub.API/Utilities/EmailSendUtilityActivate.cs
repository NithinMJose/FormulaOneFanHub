    ...
    public class EmailSendUtilityActivate
    {
        ...
        public void SendEmailActivate(User userInfo, string reason)
        {
            try
            {
                ...
                var htmlContent = $"<p>Dear {userInfo.FirstName},</p><p>Your FormulaOne FanHub account has been Re-Activated due to the following reason:</p><p><strong>{reason}</strong></p><p>Please contact the administrators for further assistance.</p><p>Best regards,<br />FormulaOneFanHub Team</p>";
