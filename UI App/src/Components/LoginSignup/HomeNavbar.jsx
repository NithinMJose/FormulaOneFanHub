  ...
  >
    <a href="/" className="navbar-brand ms-4 ms-lg-0">
      <h1 className="mb-0 text-primary text-uppercase">
        <i className="fa fa-cut me-3" />Formula 1 Fan Hub</h1>
    </a>
    <button
      type="button"
    ...
    <div className="collapse navbar-collapse" id="navbarCollapse">
      ...
      <a href="/Signup" className="btn btn-primary rounded-0 py-2 px-lg-4 d-none d-lg-block" >SignUp Now <i className="fa fa-arrow-right ms-3" /> </a>
    </div>
  </nav>
  {/* Navbar End */}
</>
